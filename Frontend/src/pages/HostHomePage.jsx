    ...
    >
      {!session ? (
        <div className="w-75 mt-5">
          <div className="d-flex flex-column gap-3 bg-black border rounded border-2 border-secondary p-3">
            <div>Add Playlist</div>
            <div className="rounded">
              <input
                className="form-control bg-black w-100 text-white"
            ...
            <div className="d-flex gap-2  bg-black border border-0">
              <button className="btn btn-danger">Close</button>
              <button className="btn btn-primary" onClick={savePlayListName}>
                Save
              </button>
            </div>
          </div>
